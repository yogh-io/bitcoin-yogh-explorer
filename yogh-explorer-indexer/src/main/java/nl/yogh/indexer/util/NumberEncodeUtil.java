...
public final class NumberEncodeUtil {
  ...
  /**
   * TODO Figure out what's happening with negative values for int values (ie. if
   * overflow is encoded correctly and it doesn't matter, in other words, whether
   * providing an int value rather than a long is sufficient)
   */
